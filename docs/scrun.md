        ...
        :   **scrun** [*GLOBAL OPTIONS*...] *state* <*container-id*>
            ...
            :   **scrun** [*GLOBAL OPTIONS*...] *kill* <*container-id*> [*signal*]
                ...
                :   **scrun** [*GLOBAL OPTIONS*...] *delete* [*DELETE OPTIONS*] <*container-id*>
                    ...
                    **SCRUN\_ACCOUNT**
                    :   See **SLURM\_ACCOUNT** from **[srun](srun.html)**(1).

                        : **SCRUN\_ACCTG\_FREQ** : See **SLURM\_ACCTG\_FREQ** from **[srun](srun.html)**(1). : **SCRUN\_BURST\_BUFFER** : See **SLURM\_BURST\_BUFFER** from **[srun](srun.html)**(1). : **SCRUN\_CLUSTER\_CONSTRAINT** : See **SLURM\_CLUSTER\_CONSTRAINT** from **[srun](srun.html)**(1). : **SCRUN\_CLUSTERS** : See **SLURM\_CLUSTERS** from **[srun](srun.html)**(1). : **SCRUN\_CONSTRAINT** : See **SLURM\_CONSTRAINT** from **[srun](srun.html)**(1). : **SLURM\_CORE\_SPEC** : See **SLURM\_ACCOUNT** from **[srun](srun.html)**(1). : **SCRUN\_CPU\_BIND** : See **SLURM\_CPU\_BIND** from **[srun](srun.html)**(1). : **SCRUN\_CPU\_FREQ\_REQ** : See **SLURM\_CPU\_FREQ\_REQ** from **[srun](srun.html)**(1). : **SCRUN\_CPUS\_PER\_GPU** : See **SLURM\_CPUS\_PER\_GPU** from **[srun](srun.html)**(1). : **SCRUN\_CPUS\_PER\_TASK** : See **SRUN\_CPUS\_PER\_TASK** from **[srun](srun.html)**(1). : **SCRUN\_DELAY\_BOOT** : See **SLURM\_DELAY\_BOOT** from **[srun](srun.html)**(1). : **SCRUN\_DEPENDENCY** : See **SLURM\_DEPENDENCY** from **[srun](srun.html)**(1). : **SCRUN\_DISTRIBUTION** : See **SLURM\_DISTRIBUTION** from **[srun](srun.html)**(1). : **SCRUN\_EPILOG** : See **SLURM\_EPILOG** from **[srun](srun.html)**(1). : **SCRUN\_EXACT** : See **SLURM\_EXACT** from **[srun](srun.html)**(1). : **SCRUN\_EXCLUSIVE** : See **SLURM\_EXCLUSIVE** from **[srun](srun.html)**(1). : **SCRUN\_GPU\_BIND** : See **SLURM\_GPU\_BIND** from **[srun](srun.html)**(1). : **SCRUN\_GPU\_FREQ** : See **SLURM\_GPU\_FREQ** from **[srun](srun.html)**(1). : **SCRUN\_GPUS** : See **SLURM\_GPUS** from **[srun](srun.html)**(1). : **SCRUN\_GPUS\_PER\_NODE** : See **SLURM\_GPUS\_PER\_NODE** from **[srun](srun.html)**(1). : **SCRUN\_GPUS\_PER\_SOCKET** : See **SLURM\_GPUS\_PER\_SOCKET** from **[salloc](salloc.html)**(1). : **SCRUN\_GPUS\_PER\_TASK** : See **SLURM\_GPUS\_PER\_TASK** from **[srun](srun.html)**(1). : **SCRUN\_GRES\_FLAGS** : See **SLURM\_GRES\_FLAGS** from **[srun](srun.html)**(1). : **SCRUN\_GRES** : See **SLURM\_GRES** from **[srun](srun.html)**(1). : **SCRUN\_HINT** : See **SLURM\_HIST** from **[srun](srun.html)**(1). : **SCRUN\_JOB\_NAME** : See **SLURM\_JOB\_NAME** from **[srun](srun.html)**(1). : **SCRUN\_JOB\_NODELIST** : See **SLURM\_JOB\_NODELIST** from **[srun](srun.html)**(1). : **SCRUN\_JOB\_NUM\_NODES** : See **SLURM\_JOB\_NUM\_NODES** from **[srun](srun.html)**(1). : **SCRUN\_LABELIO** : See **SLURM\_LABELIO** from **[srun](srun.html)**(1). : **SCRUN\_MEM\_BIND** : See **SLURM\_MEM\_BIND** from **[srun](srun.html)**(1). : **SCRUN\_MEM\_PER\_CPU** : See **SLURM\_MEM\_PER\_CPU** from **[srun](srun.html)**(1). : **SCRUN\_MEM\_PER\_GPU** : See **SLURM\_MEM\_PER\_GPU** from **[srun](srun.html)**(1). : **SCRUN\_MEM\_PER\_NODE** : See **SLURM\_MEM\_PER\_NODE** from **[srun](srun.html)**(1). : **SCRUN\_MPI\_TYPE** : See **SLURM\_MPI\_TYPE** from **[srun](srun.html)**(1). : **SCRUN\_NCORES\_PER\_SOCKET** : See **SLURM\_NCORES\_PER\_SOCKET** from **[srun](srun.html)**(1). : **SCRUN\_NETWORK** : See **SLURM\_NETWORK** from **[srun](srun.html)**(1). : **SCRUN\_NSOCKETS\_PER\_NODE** : See **SLURM\_NSOCKETS\_PER\_NODE** from **[srun](srun.html)**(1). : **SCRUN\_NTASKS** : See **SLURM\_NTASKS** from **[srun](srun.html)**(1). : **SCRUN\_NTASKS\_PER\_CORE** : See **SLURM\_NTASKS\_PER\_CORE** from **[srun](srun.html)**(1). : **SCRUN\_NTASKS\_PER\_GPU** : See **SLURM\_NTASKS\_PER\_GPU** from **[srun](srun.html)**(1). : **SCRUN\_NTASKS\_PER\_NODE** : See **SLURM\_NTASKS\_PER\_NODE** from **[srun](srun.html)**(1). : **SCRUN\_NTASKS\_PER\_TRES** : See **SLURM\_NTASKS\_PER\_TRES** from **[srun](srun.html)**(1). : **SCRUN\_OPEN\_MODE** : See **SLURM\_MODE** from **[srun](srun.html)**(1). : **SCRUN\_OVERCOMMIT** : See **SLURM\_OVERCOMMIT** from **[srun](srun.html)**(1). : **SCRUN\_OVERLAP** : See **SLURM\_OVERLAP** from **[srun](srun.html)**(1). : **SCRUN\_PARTITION** : See **SLURM\_PARTITION** from **[srun](srun.html)**(1). : **SCRUN\_POWER** : See **SLURM\_POWER** from **[srun](srun.html)**(1). : **SCRUN\_PROFILE** : See **SLURM\_PROFILE** from **[srun](srun.html)**(1). : **SCRUN\_PROLOG** : See **SLURM\_PROLOG** from **[srun](srun.html)**(1). : **SCRUN\_QOS** : See **SLURM\_QOS** from **[srun](srun.html)**(1). : **SCRUN\_REMOTE\_CWD** : See **SLURM\_REMOTE\_CWD** from **[srun](srun.html)**(1). : **SCRUN\_REQ\_SWITCH** : See **SLURM\_REQ\_SWITCH** from **[srun](srun.html)**(1). : **SCRUN\_RESERVATION** : See **SLURM\_RESERVATION** from **[srun](srun.html)**(1). : **SCRUN\_SIGNAL** : See **SLURM\_SIGNAL** from **[srun](srun.html)**(1). : **SCRUN\_SLURMD\_DEBUG** : See **SLURMD\_DEBUG** from **[srun](srun.html)**(1). : **SCRUN\_SPREAD\_JOB** : See **SLURM\_SPREAD\_JOB** from **[srun](srun.html)**(1). : **SCRUN\_TASK\_EPILOG** : See **SLURM\_TASK\_EPILOG** from **[srun](srun.html)**(1). : **SCRUN\_TASK\_PROLOG** : See **SLURM\_TASK\_PROLOG** from **[srun](srun.html)**(1). : **SCRUN\_THREAD\_SPEC** : See **SLURM\_THREAD\_SPEC** from **[srun](srun.html)**(1). : **SCRUN\_THREADS\_PER\_CORE** : See **SLURM\_THREADS\_PER\_CORE** from **[srun](srun.html)**(1). : **SCRUN\_THREADS** : See **SLURM\_THREADS** from **[srun](srun.html)**(1). : **SCRUN\_TIMELIMIT** : See **SLURM\_TIMELIMIT** from **[srun](srun.html)**(1). : **SCRUN\_TRES\_BIND** : Same as **--tres-bind** : **SCRUN\_TRES\_PER\_TASK** : See **SLURM\_TRES\_PER\_TASK** from **[srun](srun.html)**(1). : **SCRUN\_UNBUFFEREDIO** : See **SLURM\_UNBUFFEREDIO** from **[srun](srun.html)**(1). : **SCRUN\_USE\_MIN\_NODES** : See **SLURM\_USE\_MIN\_NODES** from **[srun](srun.html)**(1). : **SCRUN\_WAIT4SWITCH** : See **SLURM\_WAIT4SWITCH** from **[srun](srun.html)**(1). : **SCRUN\_WCKEY** : See **SLURM\_WCKEY** from **[srun](srun.html)**(1). : **SCRUN\_WORKING\_DIR** : See **SLURM\_WORKING\_DIR** from **[srun](srun.html)**(1).
                    ...
                    **[slurm](slurm.html)**(1), **[oci.conf](oci.conf.html)**(5), **[srun](srun.html)**(1), **crun**, **runc**,
                    **DOCKER** and **podman**
